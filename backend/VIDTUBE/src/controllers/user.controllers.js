...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //validation -->> other libraries do exist
  if (
...
const logoutUser = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .clearCookie("accessToken", options) //need to give options also otherwise it will only refresh it not clear it
...
const getWatchHistory = asyncHandler(async (req, res) => {
  const user = await User.aggregate([
    {
      $match: {
        // cant use req._id in aggregation pipelines
